...
public class GraphicUserInterface extends JFrame {
	...
	private void initComponents(){
		...
		btnNowyStan = new JButton("Nowy stan");
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
							...
							.addComponent(btnNowyStan, GroupLayout.PREFERRED_SIZE, 106, GroupLayout.PREFERRED_SIZE)
							.addContainerGap())
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(btnNowyStan, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
		...
		//przycisk akceptujacy ustawienia
		...
		mapWraping = new JCheckBox("Zawijanie mapy");
		mapWraping.setHorizontalAlignment(SwingConstants.CENTER);
		mapWraping.setBounds(10, 67, 127, 23);
		neighbors.add(mapWraping);
		...
		//tworze jakas poczatkowa plansze
	...
	private void createEvents(){
		btnNowyStan.addActionListener(new ActionListener() {
			@Override
	...
	private void readData(){
		...
		//przypisuje zawijanie
		mapWrap = mapWraping.isSelected();
	}
	...
	//zeby dostac w klasie Presenter wymiary
